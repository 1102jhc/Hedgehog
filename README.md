...
## 고슴도치 배변훈련
```
- 배변훈련은 아기 때 해야 성공률이 높다.

- 이미 쳇바퀴를 타면 불가능하다.

- 2~3주 성과가 없으면 포기하는게 좋다.

화장실에 우드펠렛을 깔고 하우스에는 배변 흔적 구별을 위해 흰색 종이베딩을 깐다. 화장실 위에 온전히 올라가서 식사를 하도록 밥그릇이 물보다 더 구석에 있어야 한다. 
하우스에 대변 흔적이 있으면 종이베딩과 함께 화장실로 옮겨주고 소동물용 냄새제거제를 뿌려주고 종이베딩을 다시 깔아준다. 소변이 있으면 주변 베딩을 버리고 유린off를 뿌린 후 최대 2~3분 후 물티슈로 닦아준 뒤 종이 베딩을 깔아준다. 화장실에는 항상 냄새가 나는 것이 좋다.
